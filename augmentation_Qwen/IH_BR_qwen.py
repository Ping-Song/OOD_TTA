...
model = AutoModelForCausalLM.from_pretrained(
    model_id,
    dtype=torch.float16, # bfloat16 or float16 is strongly recommended for Qwen over float32
...
df_ood.to_pickle('/home/pingsong/OOD_TTA/augmentation_Qwen/IH_BR_qwen.pkl')